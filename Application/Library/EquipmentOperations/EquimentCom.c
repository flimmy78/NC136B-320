...
//{
//	static	unsigned char		RecBuf[256] = {0};						//接收缓冲区
...
//			case 0xCA: 
//
////						CarddataOperate(recdsprotocolpara.databuf,recdsprotocolpara.datalen); 			//读卡器对接收的信息进行处理
